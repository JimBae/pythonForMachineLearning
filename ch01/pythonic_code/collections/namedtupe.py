# ref 
# https://github.com/TEAMLAB-Lecture/AI-python-connect/blob/master/codes/ch_1/data_structure/7/collections/namedtupe_example.py
...
from collections import namedtuple
import csv
f = open("./collections/users.csv", "r")
next(f)
reader = csv.reader(f)
student_list = []
for row in reader:
...
for row in student_list:
    student = Student(*row) ## Error failed to unpackage ??
